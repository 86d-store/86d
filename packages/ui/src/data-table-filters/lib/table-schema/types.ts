...
import type {
	DatePreset,
	Option,
} from "~/data-table-filters/components/data-table/types";
...
// biome-ignore lint/suspicious/noExplicitAny: filter type varies per column builder
...
export type InferTableType<T extends TableSchemaDefinition> = {
	// biome-ignore lint/suspicious/noExplicitAny: inferring column value type ignores filter type param
