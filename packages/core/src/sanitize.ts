...
export function isSafeUrl(url: string): boolean {
	...
	const candidate = decodeCharacterReferences(url)
		// biome-ignore lint/suspicious/noControlCharactersInRegex: matching the control characters a URL parser strips is the purpose
		.replace(/[\u0009\u000A\u000D]/g, "")
		// biome-ignore lint/suspicious/noControlCharactersInRegex: matching the control characters a URL parser strips is the purpose
		.replace(/^[\u0000-\u0020]+/, "")
		// biome-ignore lint/suspicious/noControlCharactersInRegex: matching the control characters a URL parser strips is the purpose
