...
/**
 * Persist Store Admin table UI state by stable table ID.
 * Schema version bumps discard incompatible stored state safely.
 */
export function usePersistedTableState(tableId: string) {
	...
	const patch = useCallback(
		(partial: Partial<Omit<PersistedTableState, "v">>) => {
			setState((prev) => {
